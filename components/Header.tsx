...
const Header: React.FC = () => {
    ...
    return (
        <header className="bg-slate-800 shadow-lg sticky top-0 z-40">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    <RouterNavLink to="/" className="flex-shrink-0 flex items-center gap-2 cursor-pointer">
                        <img src={logo} alt="Logo Leaderbets" className="h-12 w-auto mr-2 rounded" style={{ objectFit: 'contain' }} />
                        <h1 className="text-3xl font-black text-white hover:opacity-90 transition-opacity">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative hidden sm:block">
                            <select
                                ...
                                className="bg-slate-700 text-white rounded px-3 py-2 text-base border border-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400"
                                style={{ minWidth: 100 }}
            ...
            <div className={`md:hidden ${isMenuOpen ? 'max-h-screen' : 'max-h-0'} overflow-hidden transition-max-height duration-500 ease-in-out`}>
